    ...
    return (
        <section id="about">
            <div className="min-h-[35rem] relative w-full overflow-hidden bg-slate-900 flex flex-col items-center justify-center rounded-lg">
                ...
                <Boxes />
                <h1 className="text-2xl z-20 md:text-4xl lg:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-l from-neutral-50 to-neutral-400 bg-opacity-50">
                    About Finastra
                </h1>
