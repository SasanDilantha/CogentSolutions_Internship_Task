  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="relative max-w-6xl mx-auto pb-20">
        <div
          className="absolute top-0 left-[28px] md:left-1/2 md:-translate-x-1/2 w-[2px] z-0"
          style={{ height: `${height}px` }}
        >
          <div className="w-full h-full bg-gradient-to-b from-transparent via-neutral-300 dark:via-neutral-700 to-transparent rounded-full" />
          <motion.div
            style={{
        ...
        {data.map((item, index) => {
          ...
          return (
            ...
            >
              <div
                className={`relative flex-shrink-0 flex justify-start md:justify-end md:pr-4 md:pl-4 ${
                  isLeft ? "pl-12 md:pl-0" : "pl-12 md:pl-0"
                }`}
              >
